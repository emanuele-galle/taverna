      ...
      >
        ...
        <div className="flex flex-wrap items-center justify-center gap-4 mt-6">
          <a
            ...
            className="flex items-center gap-2 bg-gold/10 border border-gold/30 text-gold rounded-full px-5 py-2.5 text-sm font-medium hover:bg-gold/20 active:scale-[0.98] transition-all"
          >
      ...
      <section className="py-12 sm:py-16 md:py-20 bg-cream">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
            <div className="bg-white rounded-xl p-6 card-specialty hover-lift text-center">
              ...
              <h3 className="font-serif text-lg text-espresso mb-2">Dove Siamo</h3>
              <p className="text-base text-warm-grey mb-3">{restaurant.address}</p>
              <a
                href={`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(restaurant.address)}`}
                target="_blank"
                rel="noopener noreferrer"
            ...
            <div className="bg-white rounded-xl p-6 card-specialty hover-lift text-center">
              ...
              <h3 className="font-serif text-lg text-espresso mb-2">Telefono</h3>
            ...
            <div className="bg-white rounded-xl p-6 card-specialty hover-lift text-center">
              ...
              <h3 className="font-serif text-lg text-espresso mb-2">Email</h3>
            ...
            <div className="bg-white rounded-xl p-6 card-specialty hover-lift text-center">
              ...
              <h3 className="font-serif text-lg text-espresso mb-2">WhatsApp</h3>
              <p className="text-base text-warm-grey mb-3">Contattaci rapidamente</p>
              <a
          ...
          {/* Orari di Apertura */}
          <div className="bg-white rounded-xl p-6 card-specialty hover-lift mb-12 max-w-2xl mx-auto">
            ...
            <div className="divide-y divide-charcoal/5">
              {restaurant.openingHours.map((h) => (
                <div key={h.days} className="flex items-center justify-between py-3">
                  <span className="text-sm font-medium text-espresso">{h.days}</span>
          ...
          <div className="max-w-2xl mx-auto mb-12">
            <div className="text-center mb-8">
              <h2 className="font-serif font-light text-2xl text-espresso mb-2">Inviaci un Messaggio</h2>
              <p className="font-serif italic text-base text-warm-grey">
