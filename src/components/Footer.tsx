        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-12">
          ...
          <div>
            ...
            <div className="mt-6 pt-4 border-t border-white/10 flex flex-wrap gap-3">
              <Link href="/privacy" className="text-sm text-white/50 hover:text-gold transition-colors">
                Privacy Policy
              </Link>
              <span className="text-white/20">&bull;</span>
              <Link href="/cookie" className="text-sm text-white/50 hover:text-gold transition-colors">
                Cookie Policy
              </Link>
              <span className="text-white/20">&bull;</span>
              <Link href="/termini" className="text-sm text-white/50 hover:text-gold transition-colors">
