...
export default function Footer() {
  return (
    <footer className="bg-gradient-to-b from-red-900 via-red-950 to-neutral-950">
          ...
          <div>
            ...
            <div className="flex items-center gap-3">
              <a
                ...
                className="w-9 h-9 rounded-full bg-white/10 flex items-center justify-center text-white/70 hover:bg-gold hover:text-charcoal transition-all"
