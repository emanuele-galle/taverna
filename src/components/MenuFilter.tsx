...
export default function MenuFilter({ categories, activeCategory, onFilter, counts }: MenuFilterProps) {
  return (
    <div className="sticky top-20 md:top-[88px] z-30 bg-charcoal-deep/97 backdrop-blur-xl py-4 border-b border-white/10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex gap-1 overflow-x-auto scrollbar-hide pb-1">
          <button
            onClick={() => onFilter('Tutti')}
            className={`flex-shrink-0 px-5 py-2 rounded-full font-sc text-base tracking-wider transition-all duration-300 ${
